...
test : image_ppm.o seam_carver.o tests.o
	${CXX} ${CXX_FLAGS} -lc++abi tests.o image_ppm.o seam_carver.o -o test

tests.o : tests/catch.hpp includes/image_ppm.hpp includes/seam_carver.hpp tests/tests.cc tests/grader_support.hpp
